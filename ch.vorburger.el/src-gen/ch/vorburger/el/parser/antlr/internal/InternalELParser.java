...
public class InternalELParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_INT", "RULE_EINT", "RULE_STRING", "RULE_ID", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'..'", "'null'", "'NULL'", "'false'", "'FALSE'", "'true'", "'TRUE'", "'.'", "':'", "'='", "'+='", "'||'", "'&&'", "'=='", "'!='", "'>='", "'<='", "'>'", "'<'", "'+'", "'-'", "'*'", "'**'", "'/'", "'%'", "'!'", "'as'", "'?.'", "'*.'", "','", "'('", "')'", "'['", "'|'", "']'", "';'", "'if'", "'else'", "'case'", "'var'", "'val'", "'super'", "'::'", "'catch'", "'=>'", "'?'", "'extends'", "'&'"
    };
    ...
    public final AntlrDatatypeRuleToken ruleOpOther() throws RecognitionException {
        ...
        try {
            ...
            {
            kw=(Token)match(input,12,FOLLOW_12_in_ruleOpOther729); if (state.failed) return current;
            if ( state.backtracking==0 ) {
        ...
        try {
            ...
            switch (alt5) {
                case 1 :
                    ...
                    {
                    otherlv_1=(Token)match(input,13,FOLLOW_13_in_ruleXNullLiteral1355); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    otherlv_2=(Token)match(input,14,FOLLOW_14_in_ruleXNullLiteral1373); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 1 :
                    ...
                    switch (alt6) {
                        case 1 :
                            ...
                            {
                            otherlv_1=(Token)match(input,15,FOLLOW_15_in_ruleXBooleanLiteral1468); if (state.failed) return current;
                            if ( state.backtracking==0 ) {
                        ...
                        case 2 :
                            ...
                            {
                            otherlv_2=(Token)match(input,16,FOLLOW_16_in_ruleXBooleanLiteral1486); if (state.failed) return current;
                            if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    switch (alt7) {
                        case 1 :
                            ...
                            {
                            lv_isTrue_3_1=(Token)match(input,17,FOLLOW_17_in_ruleXBooleanLiteral1513); if (state.failed) return current;
                            if ( state.backtracking==0 ) {
                        ...
                        case 2 :
                            ...
                            {
                            lv_isTrue_3_2=(Token)match(input,18,FOLLOW_18_in_ruleXBooleanLiteral1542); if (state.failed) return current;
                            if ( state.backtracking==0 ) {
    ...
    public final AntlrDatatypeRuleToken ruleDate() throws RecognitionException {
        ...
        try {
            ...
            kw=(Token)match(input,19,FOLLOW_19_in_ruleDate1665); if (state.failed) return current;
            if ( state.backtracking==0 ) {
            ...
            kw=(Token)match(input,19,FOLLOW_19_in_ruleDate1698); if (state.failed) return current;
            if ( state.backtracking==0 ) {
    ...
    public final AntlrDatatypeRuleToken ruleDate_Time() throws RecognitionException {
        ...
        try {
            ...
            kw=(Token)match(input,20,FOLLOW_20_in_ruleDate_Time1855); if (state.failed) return current;
            if ( state.backtracking==0 ) {
            ...
            kw=(Token)match(input,20,FOLLOW_20_in_ruleDate_Time1888); if (state.failed) return current;
            if ( state.backtracking==0 ) {
        ...
        try {
            ...
            switch (alt9) {
                case 1 :
                    ...
                    kw=(Token)match(input,19,FOLLOW_19_in_ruleNumber2019); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
    ...
    public final EObject ruleXAssignment() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA12_0==RULE_ID) ) {
                ...
                if ( (LA12_1==EOF||(LA12_1>=RULE_INT && LA12_1<=RULE_ID)||(LA12_1>=12 && LA12_1<=20)||(LA12_1>=22 && LA12_1<=44)||(LA12_1>=46 && LA12_1<=49)||(LA12_1>=51 && LA12_1<=54)) ) {
                    alt12=2;
                }
                else if ( (LA12_1==21) ) {
                    alt12=1;
            ...
            else if ( ((LA12_0>=RULE_INT && LA12_0<=RULE_STRING)||(LA12_0>=13 && LA12_0<=18)||(LA12_0>=30 && LA12_0<=32)||LA12_0==37||LA12_0==42||LA12_0==48||LA12_0==53) ) {
                alt12=2;
            }
            else {
                if (state.backtracking>0) {state.failed=true; return current;}
    ...
    public final AntlrDatatypeRuleToken ruleOpSingleAssign() throws RecognitionException {
        ...
        try {
            ...
            {
            kw=(Token)match(input,21,FOLLOW_21_in_ruleOpSingleAssign2407); if (state.failed) return current;
            if ( state.backtracking==0 ) {
    ...
    public final AntlrDatatypeRuleToken ruleOpMultiAssign() throws RecognitionException {
        ...
        try {
            ...
            {
            kw=(Token)match(input,22,FOLLOW_22_in_ruleOpMultiAssign2495); if (state.failed) return current;
            if ( state.backtracking==0 ) {
    ...
    public final AntlrDatatypeRuleToken ruleOpOr() throws RecognitionException {
        ...
        try {
            ...
            {
            kw=(Token)match(input,23,FOLLOW_23_in_ruleOpOr2754); if (state.failed) return current;
            if ( state.backtracking==0 ) {
    ...
    public final AntlrDatatypeRuleToken ruleOpAnd() throws RecognitionException {
        ...
        try {
            ...
            {
            kw=(Token)match(input,24,FOLLOW_24_in_ruleOpAnd3013); if (state.failed) return current;
            if ( state.backtracking==0 ) {
        ...
        try {
            ...
            switch (alt16) {
                case 1 :
                    ...
                    {
                    kw=(Token)match(input,25,FOLLOW_25_in_ruleOpEquality3273); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    kw=(Token)match(input,26,FOLLOW_26_in_ruleOpEquality3292); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    {
                    kw=(Token)match(input,27,FOLLOW_27_in_ruleOpCompare3382); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    kw=(Token)match(input,28,FOLLOW_28_in_ruleOpCompare3401); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 3 :
                    ...
                    {
                    kw=(Token)match(input,29,FOLLOW_29_in_ruleOpCompare3420); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 4 :
                    ...
                    {
                    kw=(Token)match(input,30,FOLLOW_30_in_ruleOpCompare3439); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            switch (alt19) {
                case 1 :
                    ...
                    {
                    kw=(Token)match(input,31,FOLLOW_31_in_ruleOpAdd3700); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    kw=(Token)match(input,32,FOLLOW_32_in_ruleOpAdd3719); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            switch (alt21) {
                case 1 :
                    ...
                    {
                    kw=(Token)match(input,33,FOLLOW_33_in_ruleOpMulti3980); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    kw=(Token)match(input,34,FOLLOW_34_in_ruleOpMulti3999); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 3 :
                    ...
                    {
                    kw=(Token)match(input,35,FOLLOW_35_in_ruleOpMulti4018); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 4 :
                    ...
                    {
                    kw=(Token)match(input,36,FOLLOW_36_in_ruleOpMulti4037); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
    ...
    public final EObject ruleXUnaryOperation() throws RecognitionException {
        ...
        try {
            ...
            if ( ((LA22_0>=31 && LA22_0<=32)||LA22_0==37) ) {
                alt22=1;
            }
            else if ( ((LA22_0>=RULE_INT && LA22_0<=RULE_ID)||(LA22_0>=13 && LA22_0<=18)||LA22_0==30||LA22_0==42||LA22_0==48||LA22_0==53) ) {
                alt22=2;
            }
            else {
                if (state.backtracking>0) {state.failed=true; return current;}
        ...
        try {
            ...
            switch (alt23) {
                case 1 :
                    ...
                    {
                    kw=(Token)match(input,37,FOLLOW_37_in_ruleOpUnary4280); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    kw=(Token)match(input,32,FOLLOW_32_in_ruleOpUnary4299); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 3 :
                    ...
                    {
                    kw=(Token)match(input,31,FOLLOW_31_in_ruleOpUnary4318); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    otherlv_2=(Token)match(input,38,FOLLOW_38_in_ruleXCastedExpression4450); if (state.failed) return current;
            	    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    otherlv_2=(Token)match(input,19,FOLLOW_19_in_ruleXMemberFeatureCall4617); if (state.failed) return current;
            	    if ( state.backtracking==0 ) {
            	...
            	case 2 :
            	    ...
            	    switch (alt25) {
            	        case 1 :
            	            ...
            	            {
            	            otherlv_7=(Token)match(input,19,FOLLOW_19_in_ruleXMemberFeatureCall4764); if (state.failed) return current;
            	            if ( state.backtracking==0 ) {
            	        ...
            	        case 2 :
            	            ...
            	            {
            	            lv_nullSafe_8_0=(Token)match(input,39,FOLLOW_39_in_ruleXMemberFeatureCall4788); if (state.failed) return current;
            	            if ( state.backtracking==0 ) {
            	        ...
            	        case 3 :
            	            ...
            	            {
            	            lv_spreading_9_0=(Token)match(input,40,FOLLOW_40_in_ruleXMemberFeatureCall4825); if (state.failed) return current;
            	            if ( state.backtracking==0 ) {
            	    ...
            	    switch (alt27) {
            	        case 1 :
            	            ...
            	            {
            	            otherlv_10=(Token)match(input,30,FOLLOW_30_in_ruleXMemberFeatureCall4854); if (state.failed) return current;
            	            if ( state.backtracking==0 ) {
            	            ...
            	            do {
            	            	...
            	            	case 1 :
            	            	    ...
            	            	    {
            	            	    otherlv_12=(Token)match(input,41,FOLLOW_41_in_ruleXMemberFeatureCall4888); if (state.failed) return current;
            	            	    if ( state.backtracking==0 ) {
            	            ...
            	            otherlv_14=(Token)match(input,29,FOLLOW_29_in_ruleXMemberFeatureCall4923); if (state.failed) return current;
            	            if ( state.backtracking==0 ) {
            	    ...
            	    switch (alt30) {
            	        case 1 :
            	            ...
            	            {
            	            lv_explicitOperationCall_16_0=(Token)match(input,42,FOLLOW_42_in_ruleXMemberFeatureCall4982); if (state.failed) return current;
            	            if ( state.backtracking==0 ) {
            	                ...
            	                case 2 :
            	                    ...
            	                    do {
            	                    	...
            	                    	case 1 :
            	                    	    ...
            	                    	    {
            	                    	    otherlv_19=(Token)match(input,41,FOLLOW_41_in_ruleXMemberFeatureCall5108); if (state.failed) return current;
            	                    	    if ( state.backtracking==0 ) {
            	            ...
            	            otherlv_21=(Token)match(input,43,FOLLOW_43_in_ruleXMemberFeatureCall5146); if (state.failed) return current;
            	            if ( state.backtracking==0 ) {
            	    ...
            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2054:3: ( ( ( ruleXClosure ) )=> (lv_memberCallArguments_22_0= ruleXClosure ) )?
            	    int alt31=2;
            	    int LA31_0 = input.LA(1);

            	    if ( (LA31_0==44) && (synpred14_InternalEL())) {
            	        alt31=1;
            	    }
            	    switch (alt31) {
            	        case 1 :
            	            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2054:4: ( ( ruleXClosure ) )=> (lv_memberCallArguments_22_0= ruleXClosure )
            	            {
            	            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2059:1: (lv_memberCallArguments_22_0= ruleXClosure )
            	            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2060:3: lv_memberCallArguments_22_0= ruleXClosure
            	            {
            	            if ( state.backtracking==0 ) {
            	            ...
            	            pushFollow(FOLLOW_ruleXClosure_in_ruleXMemberFeatureCall5179);
            	            lv_memberCallArguments_22_0=ruleXClosure();
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2084:1: entryRuleXClosure returns [EObject current=null] : iv_ruleXClosure= ruleXClosure EOF ;
    public final EObject entryRuleXClosure() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2085:2: (iv_ruleXClosure= ruleXClosure EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2086:2: iv_ruleXClosure= ruleXClosure EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getXClosureRule()); 
            }
            pushFollow(FOLLOW_ruleXClosure_in_entryRuleXClosure5219);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXClosure5229); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2093:1: ruleXClosure returns [EObject current=null] : ( () otherlv_1= '[' ( ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )=> ( ( ( (lv_declaredFormalParameters_2_0= ruleJvmFormalParameter ) ) (otherlv_3= ',' ( (lv_declaredFormalParameters_4_0= ruleJvmFormalParameter ) ) )* )? ( (lv_explicitSyntax_5_0= '|' ) ) ) )? ( (lv_expression_6_0= ruleXExpressionInClosure ) ) otherlv_7= ']' ) ;
    public final EObject ruleXClosure() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2096:28: ( ( () otherlv_1= '[' ( ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )=> ( ( ( (lv_declaredFormalParameters_2_0= ruleJvmFormalParameter ) ) (otherlv_3= ',' ( (lv_declaredFormalParameters_4_0= ruleJvmFormalParameter ) ) )* )? ( (lv_explicitSyntax_5_0= '|' ) ) ) )? ( (lv_expression_6_0= ruleXExpressionInClosure ) ) otherlv_7= ']' ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2097:1: ( () otherlv_1= '[' ( ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )=> ( ( ( (lv_declaredFormalParameters_2_0= ruleJvmFormalParameter ) ) (otherlv_3= ',' ( (lv_declaredFormalParameters_4_0= ruleJvmFormalParameter ) ) )* )? ( (lv_explicitSyntax_5_0= '|' ) ) ) )? ( (lv_expression_6_0= ruleXExpressionInClosure ) ) otherlv_7= ']' )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2097:1: ( () otherlv_1= '[' ( ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )=> ( ( ( (lv_declaredFormalParameters_2_0= ruleJvmFormalParameter ) ) (otherlv_3= ',' ( (lv_declaredFormalParameters_4_0= ruleJvmFormalParameter ) ) )* )? ( (lv_explicitSyntax_5_0= '|' ) ) ) )? ( (lv_expression_6_0= ruleXExpressionInClosure ) ) otherlv_7= ']' )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2097:2: () otherlv_1= '[' ( ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )=> ( ( ( (lv_declaredFormalParameters_2_0= ruleJvmFormalParameter ) ) (otherlv_3= ',' ( (lv_declaredFormalParameters_4_0= ruleJvmFormalParameter ) ) )* )? ( (lv_explicitSyntax_5_0= '|' ) ) ) )? ( (lv_expression_6_0= ruleXExpressionInClosure ) ) otherlv_7= ']'
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2097:2: ()
            ...
            otherlv_1=(Token)match(input,44,FOLLOW_44_in_ruleXClosure5275); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_1, grammarAccess.getXClosureAccess().getLeftSquareBracketKeyword_1());
                  
            }
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2107:1: ( ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )=> ( ( ( (lv_declaredFormalParameters_2_0= ruleJvmFormalParameter ) ) (otherlv_3= ',' ( (lv_declaredFormalParameters_4_0= ruleJvmFormalParameter ) ) )* )? ( (lv_explicitSyntax_5_0= '|' ) ) ) )?
            int alt35=2;
            alt35 = dfa35.predict(input);
            switch (alt35) {
                case 1 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2107:2: ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )=> ( ( ( (lv_declaredFormalParameters_2_0= ruleJvmFormalParameter ) ) (otherlv_3= ',' ( (lv_declaredFormalParameters_4_0= ruleJvmFormalParameter ) ) )* )? ( (lv_explicitSyntax_5_0= '|' ) ) )
                    {
                    ...
                    if ( (LA34_0==RULE_ID||LA34_0==42||LA34_0==56) ) {
                        alt34=1;
                    }
                    switch (alt34) {
                        case 1 :
                            ...
                            do {
                            	...
                            	case 1 :
                            	    ...
                            	    {
                            	    otherlv_3=(Token)match(input,41,FOLLOW_41_in_ruleXClosure5359); if (state.failed) return current;
                            	    if ( state.backtracking==0 ) {
                    ...
                    {
                    lv_explicitSyntax_5_0=(Token)match(input,45,FOLLOW_45_in_ruleXClosure5402); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleXExpressionInClosure_in_ruleXClosure5439);
            ...
            otherlv_7=(Token)match(input,46,FOLLOW_46_in_ruleXClosure5451); if (state.failed) return current;
            if ( state.backtracking==0 ) {
    ...
    public final EObject entryRuleXExpressionInClosure() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleXExpressionInClosure_in_entryRuleXExpressionInClosure5487);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXExpressionInClosure5497); if (state.failed) return current;
    ...
    public final EObject ruleXExpressionInClosure() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA37_0>=RULE_INT && LA37_0<=RULE_ID)||(LA37_0>=13 && LA37_0<=18)||(LA37_0>=30 && LA37_0<=32)||LA37_0==37||LA37_0==42||LA37_0==48||(LA37_0>=51 && LA37_0<=53)) ) {
                    alt37=1;
                }
            	...
            	case 1 :
            	    ...
            	    pushFollow(FOLLOW_ruleXExpressionInsideBlock_in_ruleXExpressionInClosure5553);
            	    ...
            	    switch (alt36) {
            	        case 1 :
            	            ...
            	            {
            	            otherlv_2=(Token)match(input,47,FOLLOW_47_in_ruleXExpressionInClosure5566); if (state.failed) return current;
            	            if ( state.backtracking==0 ) {
    ...
    public final EObject entryRuleXShortClosure() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleXShortClosure_in_entryRuleXShortClosure5606);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXShortClosure5616); if (state.failed) return current;
    ...
    public final EObject ruleXShortClosure() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA39_0==RULE_ID||LA39_0==42||LA39_0==56) ) {
                alt39=1;
            }
            switch (alt39) {
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    otherlv_2=(Token)match(input,41,FOLLOW_41_in_ruleXShortClosure5737); if (state.failed) return current;
                    	    if ( state.backtracking==0 ) {
            ...
            {
            lv_explicitSyntax_4_0=(Token)match(input,45,FOLLOW_45_in_ruleXShortClosure5780); if (state.failed) return current;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleXExpression_in_ruleXShortClosure5816);
    ...
    public final EObject entryRuleXParenthesizedExpression() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleXParenthesizedExpression_in_entryRuleXParenthesizedExpression5852);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXParenthesizedExpression5862); if (state.failed) return current;
    ...
    public final EObject ruleXParenthesizedExpression() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,42,FOLLOW_42_in_ruleXParenthesizedExpression5899); if (state.failed) return current;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleXExpression_in_ruleXParenthesizedExpression5921);
            ...
            otherlv_2=(Token)match(input,43,FOLLOW_43_in_ruleXParenthesizedExpression5932); if (state.failed) return current;
            if ( state.backtracking==0 ) {
    ...
    public final EObject entryRuleXIfExpression() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleXIfExpression_in_entryRuleXIfExpression5968);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXIfExpression5978); if (state.failed) return current;
    ...
    public final EObject ruleXIfExpression() throws RecognitionException {
        ...
        try {
            ...
            otherlv_1=(Token)match(input,48,FOLLOW_48_in_ruleXIfExpression6024); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_1, grammarAccess.getXIfExpressionAccess().getIfKeyword_1());
                  
            }
            otherlv_2=(Token)match(input,42,FOLLOW_42_in_ruleXIfExpression6036); if (state.failed) return current;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleXExpression_in_ruleXIfExpression6057);
            ...
            otherlv_4=(Token)match(input,43,FOLLOW_43_in_ruleXIfExpression6069); if (state.failed) return current;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleXExpression_in_ruleXIfExpression6090);
            ...
            switch (alt40) {
                case 1 :
                    ...
                    {
                    otherlv_6=(Token)match(input,49,FOLLOW_49_in_ruleXIfExpression6111); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleXExpression_in_ruleXIfExpression6133);
    ...
    public final EObject entryRuleXCasePart() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleXCasePart_in_entryRuleXCasePart6173);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXCasePart6183); if (state.failed) return current;
    ...
    public final EObject ruleXCasePart() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA41_0==RULE_ID||LA41_0==42||LA41_0==56) ) {
                alt41=1;
            }
            switch (alt41) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleXCasePart6229);
            ...
            switch (alt42) {
                case 1 :
                    ...
                    {
                    otherlv_1=(Token)match(input,50,FOLLOW_50_in_ruleXCasePart6243); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleXExpression_in_ruleXCasePart6264);
            ...
            otherlv_3=(Token)match(input,20,FOLLOW_20_in_ruleXCasePart6278); if (state.failed) return current;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleXExpression_in_ruleXCasePart6299);
    ...
    public final EObject entryRuleXExpressionInsideBlock() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleXExpressionInsideBlock_in_entryRuleXExpressionInsideBlock6343);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXExpressionInsideBlock6353); if (state.failed) return current;
    ...
    public final EObject ruleXExpressionInsideBlock() throws RecognitionException {
        ...
        try {
            ...
            else if ( ((LA43_0>=RULE_INT && LA43_0<=RULE_ID)||(LA43_0>=13 && LA43_0<=18)||(LA43_0>=30 && LA43_0<=32)||LA43_0==37||LA43_0==42||LA43_0==48||LA43_0==53) ) {
                alt43=2;
            }
            else {
                if (state.backtracking>0) {state.failed=true; return current;}
            ...
            switch (alt43) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_ruleXVariableDeclaration_in_ruleXExpressionInsideBlock6400);
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_ruleXExpression_in_ruleXExpressionInsideBlock6427);
                    this_XExpression_1=ruleXExpression();
    ...
    public final EObject entryRuleXVariableDeclaration() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleXVariableDeclaration_in_entryRuleXVariableDeclaration6462);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXVariableDeclaration6472); if (state.failed) return current;
        ...
        try {
            ...
            switch (alt44) {
                case 1 :
                    ...
                    {
                    lv_writeable_1_0=(Token)match(input,51,FOLLOW_51_in_ruleXVariableDeclaration6525); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    otherlv_2=(Token)match(input,52,FOLLOW_52_in_ruleXVariableDeclaration6556); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
            ...
            else if ( (LA45_0==42) && (synpred18_InternalEL())) {
                alt45=1;
            }
            else if ( (LA45_0==56) && (synpred18_InternalEL())) {
                alt45=1;
            }
            else {
                if (state.backtracking>0) {state.failed=true; return current;}
            ...
            switch (alt45) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleXVariableDeclaration6604);
                    lv_type_3_0=ruleJvmTypeReference();
                    ...
                    pushFollow(FOLLOW_ruleValidID_in_ruleXVariableDeclaration6625);
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_ruleValidID_in_ruleXVariableDeclaration6654);
            ...
            switch (alt46) {
                case 1 :
                    ...
                    {
                    otherlv_6=(Token)match(input,21,FOLLOW_21_in_ruleXVariableDeclaration6668); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleXExpression_in_ruleXVariableDeclaration6689);
    ...
    public final EObject entryRuleJvmFormalParameter() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleJvmFormalParameter_in_entryRuleJvmFormalParameter6727);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleJvmFormalParameter6737); if (state.failed) return current;
    ...
    public final EObject ruleJvmFormalParameter() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA47_0==RULE_ID) ) {
                ...
                if ( (LA47_1==RULE_ID||LA47_1==19||LA47_1==30||LA47_1==44) ) {
                    alt47=1;
                }
            }
            else if ( (LA47_0==42||LA47_0==56) ) {
                alt47=1;
            }
            switch (alt47) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleJvmFormalParameter6783);
            ...
            pushFollow(FOLLOW_ruleValidID_in_ruleJvmFormalParameter6805);
    ...
    public final EObject entryRuleFullJvmFormalParameter() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleFullJvmFormalParameter_in_entryRuleFullJvmFormalParameter6841);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleFullJvmFormalParameter6851); if (state.failed) return current;
    ...
    public final EObject ruleFullJvmFormalParameter() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleFullJvmFormalParameter6897);
            lv_parameterType_0_0=ruleJvmTypeReference();
            ...
            pushFollow(FOLLOW_ruleValidID_in_ruleFullJvmFormalParameter6918);
            lv_name_1_0=ruleValidID();
    ...
    public final EObject entryRuleXFeatureCall() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleXFeatureCall_in_entryRuleXFeatureCall6954);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXFeatureCall6964); if (state.failed) return current;
        ...
        try {
            ...
            switch (alt48) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_ruleStaticQualifier_in_ruleXFeatureCall7021);
                    ruleStaticQualifier();
            ...
            switch (alt50) {
                case 1 :
                    ...
                    {
                    otherlv_2=(Token)match(input,30,FOLLOW_30_in_ruleXFeatureCall7035); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleJvmArgumentTypeReference_in_ruleXFeatureCall7056);
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    otherlv_4=(Token)match(input,41,FOLLOW_41_in_ruleXFeatureCall7069); if (state.failed) return current;
                    	    if ( state.backtracking==0 ) {
                    	    ...
                    	    pushFollow(FOLLOW_ruleJvmArgumentTypeReference_in_ruleXFeatureCall7090);
                    ...
                    otherlv_6=(Token)match(input,29,FOLLOW_29_in_ruleXFeatureCall7104); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleIdOrSuper_in_ruleXFeatureCall7129);
            ruleIdOrSuper();
            ...
            switch (alt53) {
                case 1 :
                    ...
                    {
                    lv_explicitOperationCall_8_0=(Token)match(input,42,FOLLOW_42_in_ruleXFeatureCall7163); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                    ...
                    switch (alt52) {
                        case 1 :
                            ...
                            pushFollow(FOLLOW_ruleXShortClosure_in_ruleXFeatureCall7248);
                        ...
                        case 2 :
                            ...
                            pushFollow(FOLLOW_ruleXExpression_in_ruleXFeatureCall7276);
                            ...
                            do {
                            	...
                            	case 1 :
                            	    ...
                            	    {
                            	    otherlv_11=(Token)match(input,41,FOLLOW_41_in_ruleXFeatureCall7289); if (state.failed) return current;
                            	    if ( state.backtracking==0 ) {
                            	    ...
                            	    pushFollow(FOLLOW_ruleXExpression_in_ruleXFeatureCall7310);
                    ...
                    otherlv_13=(Token)match(input,43,FOLLOW_43_in_ruleXFeatureCall7327); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
            ...
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3084:3: ( ( ( ruleXClosure ) )=> (lv_featureCallArguments_14_0= ruleXClosure ) )?
            int alt54=2;
            int LA54_0 = input.LA(1);

            if ( (LA54_0==44) && (synpred21_InternalEL())) {
                alt54=1;
            }
            switch (alt54) {
                case 1 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3084:4: ( ( ruleXClosure ) )=> (lv_featureCallArguments_14_0= ruleXClosure )
                    {
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3089:1: (lv_featureCallArguments_14_0= ruleXClosure )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3090:3: lv_featureCallArguments_14_0= ruleXClosure
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleXClosure_in_ruleXFeatureCall7360);
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3114:1: entryRuleIdOrSuper returns [String current=null] : iv_ruleIdOrSuper= ruleIdOrSuper EOF ;
    public final String entryRuleIdOrSuper() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3115:2: (iv_ruleIdOrSuper= ruleIdOrSuper EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3116:2: iv_ruleIdOrSuper= ruleIdOrSuper EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getIdOrSuperRule()); 
            }
            pushFollow(FOLLOW_ruleIdOrSuper_in_entryRuleIdOrSuper7398);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleIdOrSuper7409); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3123:1: ruleIdOrSuper returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_ValidID_0= ruleValidID | kw= 'super' ) ;
    public final AntlrDatatypeRuleToken ruleIdOrSuper() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3126:28: ( (this_ValidID_0= ruleValidID | kw= 'super' ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3127:1: (this_ValidID_0= ruleValidID | kw= 'super' )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3127:1: (this_ValidID_0= ruleValidID | kw= 'super' )
            int alt55=2;
            ...
            switch (alt55) {
                case 1 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3128:5: this_ValidID_0= ruleValidID
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleValidID_in_ruleIdOrSuper7456);
                    ...
                    break;
                case 2 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3140:2: kw= 'super'
                    {
                    kw=(Token)match(input,53,FOLLOW_53_in_ruleIdOrSuper7480); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3153:1: entryRuleStaticQualifier returns [String current=null] : iv_ruleStaticQualifier= ruleStaticQualifier EOF ;
    public final String entryRuleStaticQualifier() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3154:2: (iv_ruleStaticQualifier= ruleStaticQualifier EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3155:2: iv_ruleStaticQualifier= ruleStaticQualifier EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getStaticQualifierRule()); 
            }
            pushFollow(FOLLOW_ruleStaticQualifier_in_entryRuleStaticQualifier7521);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleStaticQualifier7532); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3162:1: ruleStaticQualifier returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_ValidID_0= ruleValidID kw= '::' )+ ;
    public final AntlrDatatypeRuleToken ruleStaticQualifier() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3165:28: ( (this_ValidID_0= ruleValidID kw= '::' )+ )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3166:1: (this_ValidID_0= ruleValidID kw= '::' )+
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3166:1: (this_ValidID_0= ruleValidID kw= '::' )+
            int cnt56=0;
            loop56:
            do {
                ...
                switch (alt56) {
            	case 1 :
            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3167:5: this_ValidID_0= ruleValidID kw= '::'
            	    {
            	    if ( state.backtracking==0 ) {
            	    ...
            	    pushFollow(FOLLOW_ruleValidID_in_ruleStaticQualifier7579);
            	    this_ValidID_0=ruleValidID();
            	    ...
            	    kw=(Token)match(input,54,FOLLOW_54_in_ruleStaticQualifier7597); if (state.failed) return current;
            	    if ( state.backtracking==0 ) {
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3195:1: entryRuleXStringLiteral returns [EObject current=null] : iv_ruleXStringLiteral= ruleXStringLiteral EOF ;
    public final EObject entryRuleXStringLiteral() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3196:2: (iv_ruleXStringLiteral= ruleXStringLiteral EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3197:2: iv_ruleXStringLiteral= ruleXStringLiteral EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getXStringLiteralRule()); 
            }
            pushFollow(FOLLOW_ruleXStringLiteral_in_entryRuleXStringLiteral7642);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXStringLiteral7652); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3204:1: ruleXStringLiteral returns [EObject current=null] : ( () ( (lv_value_1_0= RULE_STRING ) ) ) ;
    public final EObject ruleXStringLiteral() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3207:28: ( ( () ( (lv_value_1_0= RULE_STRING ) ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3208:1: ( () ( (lv_value_1_0= RULE_STRING ) ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3208:1: ( () ( (lv_value_1_0= RULE_STRING ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3208:2: () ( (lv_value_1_0= RULE_STRING ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3208:2: ()
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3209:5: 
            {
            if ( state.backtracking==0 ) {
            ...
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3214:2: ( (lv_value_1_0= RULE_STRING ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3215:1: (lv_value_1_0= RULE_STRING )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3215:1: (lv_value_1_0= RULE_STRING )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3216:3: lv_value_1_0= RULE_STRING
            {
            lv_value_1_0=(Token)match(input,RULE_STRING,FOLLOW_RULE_STRING_in_ruleXStringLiteral7703); if (state.failed) return current;
            if ( state.backtracking==0 ) {
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3248:1: entryRuleXCatchClause returns [EObject current=null] : iv_ruleXCatchClause= ruleXCatchClause EOF ;
    public final EObject entryRuleXCatchClause() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3249:2: (iv_ruleXCatchClause= ruleXCatchClause EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3250:2: iv_ruleXCatchClause= ruleXCatchClause EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getXCatchClauseRule()); 
            }
            pushFollow(FOLLOW_ruleXCatchClause_in_entryRuleXCatchClause7752);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXCatchClause7762); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3257:1: ruleXCatchClause returns [EObject current=null] : ( ( ( 'catch' )=>otherlv_0= 'catch' ) otherlv_1= '(' ( (lv_declaredParam_2_0= ruleFullJvmFormalParameter ) ) otherlv_3= ')' ( (lv_expression_4_0= ruleXExpression ) ) ) ;
    public final EObject ruleXCatchClause() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3260:28: ( ( ( ( 'catch' )=>otherlv_0= 'catch' ) otherlv_1= '(' ( (lv_declaredParam_2_0= ruleFullJvmFormalParameter ) ) otherlv_3= ')' ( (lv_expression_4_0= ruleXExpression ) ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3261:1: ( ( ( 'catch' )=>otherlv_0= 'catch' ) otherlv_1= '(' ( (lv_declaredParam_2_0= ruleFullJvmFormalParameter ) ) otherlv_3= ')' ( (lv_expression_4_0= ruleXExpression ) ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3261:1: ( ( ( 'catch' )=>otherlv_0= 'catch' ) otherlv_1= '(' ( (lv_declaredParam_2_0= ruleFullJvmFormalParameter ) ) otherlv_3= ')' ( (lv_expression_4_0= ruleXExpression ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3261:2: ( ( 'catch' )=>otherlv_0= 'catch' ) otherlv_1= '(' ( (lv_declaredParam_2_0= ruleFullJvmFormalParameter ) ) otherlv_3= ')' ( (lv_expression_4_0= ruleXExpression ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3261:2: ( ( 'catch' )=>otherlv_0= 'catch' )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3261:3: ( 'catch' )=>otherlv_0= 'catch'
            {
            otherlv_0=(Token)match(input,55,FOLLOW_55_in_ruleXCatchClause7807); if (state.failed) return current;
            if ( state.backtracking==0 ) {
            ...
            otherlv_1=(Token)match(input,42,FOLLOW_42_in_ruleXCatchClause7820); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_1, grammarAccess.getXCatchClauseAccess().getLeftParenthesisKeyword_1());
                  
            }
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3270:1: ( (lv_declaredParam_2_0= ruleFullJvmFormalParameter ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3271:1: (lv_declaredParam_2_0= ruleFullJvmFormalParameter )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3271:1: (lv_declaredParam_2_0= ruleFullJvmFormalParameter )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3272:3: lv_declaredParam_2_0= ruleFullJvmFormalParameter
            {
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleFullJvmFormalParameter_in_ruleXCatchClause7841);
            ...
            otherlv_3=(Token)match(input,43,FOLLOW_43_in_ruleXCatchClause7853); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_3, grammarAccess.getXCatchClauseAccess().getRightParenthesisKeyword_3());
                  
            }
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3292:1: ( (lv_expression_4_0= ruleXExpression ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3293:1: (lv_expression_4_0= ruleXExpression )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3293:1: (lv_expression_4_0= ruleXExpression )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3294:3: lv_expression_4_0= ruleXExpression
            {
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleXExpression_in_ruleXCatchClause7874);
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3318:1: entryRuleQualifiedName returns [String current=null] : iv_ruleQualifiedName= ruleQualifiedName EOF ;
    public final String entryRuleQualifiedName() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3319:2: (iv_ruleQualifiedName= ruleQualifiedName EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3320:2: iv_ruleQualifiedName= ruleQualifiedName EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getQualifiedNameRule()); 
            }
            pushFollow(FOLLOW_ruleQualifiedName_in_entryRuleQualifiedName7911);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleQualifiedName7922); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3327:1: ruleQualifiedName returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_ValidID_0= ruleValidID ( ( ( '.' )=>kw= '.' ) this_ValidID_2= ruleValidID )* ) ;
    public final AntlrDatatypeRuleToken ruleQualifiedName() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3330:28: ( (this_ValidID_0= ruleValidID ( ( ( '.' )=>kw= '.' ) this_ValidID_2= ruleValidID )* ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3331:1: (this_ValidID_0= ruleValidID ( ( ( '.' )=>kw= '.' ) this_ValidID_2= ruleValidID )* )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3331:1: (this_ValidID_0= ruleValidID ( ( ( '.' )=>kw= '.' ) this_ValidID_2= ruleValidID )* )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3332:5: this_ValidID_0= ruleValidID ( ( ( '.' )=>kw= '.' ) this_ValidID_2= ruleValidID )*
            {
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleValidID_in_ruleQualifiedName7969);
            this_ValidID_0=ruleValidID();
            ...
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3342:1: ( ( ( '.' )=>kw= '.' ) this_ValidID_2= ruleValidID )*
            loop57:
            do {
                int alt57=2;
                ...
                switch (alt57) {
            	case 1 :
            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3342:2: ( ( '.' )=>kw= '.' ) this_ValidID_2= ruleValidID
            	    {
            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3342:2: ( ( '.' )=>kw= '.' )
            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3342:3: ( '.' )=>kw= '.'
            	    {
            	    kw=(Token)match(input,19,FOLLOW_19_in_ruleQualifiedName7997); if (state.failed) return current;
            	    if ( state.backtracking==0 ) {
            	    ...
            	    pushFollow(FOLLOW_ruleValidID_in_ruleQualifiedName8020);
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3369:1: entryRuleJvmTypeReference returns [EObject current=null] : iv_ruleJvmTypeReference= ruleJvmTypeReference EOF ;
    public final EObject entryRuleJvmTypeReference() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3370:2: (iv_ruleJvmTypeReference= ruleJvmTypeReference EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3371:2: iv_ruleJvmTypeReference= ruleJvmTypeReference EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getJvmTypeReferenceRule()); 
            }
            pushFollow(FOLLOW_ruleJvmTypeReference_in_entryRuleJvmTypeReference8067);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleJvmTypeReference8077); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3378:1: ruleJvmTypeReference returns [EObject current=null] : ( (this_JvmParameterizedTypeReference_0= ruleJvmParameterizedTypeReference ( ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' ) )* ) | this_XFunctionTypeRef_4= ruleXFunctionTypeRef ) ;
    public final EObject ruleJvmTypeReference() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3381:28: ( ( (this_JvmParameterizedTypeReference_0= ruleJvmParameterizedTypeReference ( ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' ) )* ) | this_XFunctionTypeRef_4= ruleXFunctionTypeRef ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3382:1: ( (this_JvmParameterizedTypeReference_0= ruleJvmParameterizedTypeReference ( ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' ) )* ) | this_XFunctionTypeRef_4= ruleXFunctionTypeRef )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3382:1: ( (this_JvmParameterizedTypeReference_0= ruleJvmParameterizedTypeReference ( ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' ) )* ) | this_XFunctionTypeRef_4= ruleXFunctionTypeRef )
            int alt59=2;
            ...
            switch (alt59) {
                case 1 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3382:2: (this_JvmParameterizedTypeReference_0= ruleJvmParameterizedTypeReference ( ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' ) )* )
                    {
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3382:2: (this_JvmParameterizedTypeReference_0= ruleJvmParameterizedTypeReference ( ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' ) )* )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3383:5: this_JvmParameterizedTypeReference_0= ruleJvmParameterizedTypeReference ( ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' ) )*
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleJvmParameterizedTypeReference_in_ruleJvmTypeReference8125);
                    ...
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3391:1: ( ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' ) )*
                    loop58:
                    do {
                        int alt58=2;
                        int LA58_0 = input.LA(1);

                        if ( (LA58_0==44) && (synpred24_InternalEL())) {
                            alt58=1;
                        }
                        ...
                        switch (alt58) {
                    	case 1 :
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3391:2: ( ( () '[' ']' ) )=> ( () otherlv_2= '[' otherlv_3= ']' )
                    	    {
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3394:5: ( () otherlv_2= '[' otherlv_3= ']' )
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3394:6: () otherlv_2= '[' otherlv_3= ']'
                    	    {
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3394:6: ()
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3395:5: 
                    	    {
                    	    if ( state.backtracking==0 ) {
                    	    ...
                    	    otherlv_2=(Token)match(input,44,FOLLOW_44_in_ruleJvmTypeReference8163); if (state.failed) return current;
                    	    if ( state.backtracking==0 ) {

                    	          	newLeafNode(otherlv_2, grammarAccess.getJvmTypeReferenceAccess().getLeftSquareBracketKeyword_0_1_0_1());
                    	          
                    	    }
                    	    otherlv_3=(Token)match(input,46,FOLLOW_46_in_ruleJvmTypeReference8175); if (state.failed) return current;
                    	    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 2 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3410:5: this_XFunctionTypeRef_4= ruleXFunctionTypeRef
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleXFunctionTypeRef_in_ruleJvmTypeReference8207);
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3426:1: entryRuleXFunctionTypeRef returns [EObject current=null] : iv_ruleXFunctionTypeRef= ruleXFunctionTypeRef EOF ;
    public final EObject entryRuleXFunctionTypeRef() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3427:2: (iv_ruleXFunctionTypeRef= ruleXFunctionTypeRef EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3428:2: iv_ruleXFunctionTypeRef= ruleXFunctionTypeRef EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getXFunctionTypeRefRule()); 
            }
            pushFollow(FOLLOW_ruleXFunctionTypeRef_in_entryRuleXFunctionTypeRef8242);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleXFunctionTypeRef8252); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3435:1: ruleXFunctionTypeRef returns [EObject current=null] : ( (otherlv_0= '(' ( ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )* )? otherlv_4= ')' )? otherlv_5= '=>' ( (lv_returnType_6_0= ruleJvmTypeReference ) ) ) ;
    public final EObject ruleXFunctionTypeRef() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3438:28: ( ( (otherlv_0= '(' ( ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )* )? otherlv_4= ')' )? otherlv_5= '=>' ( (lv_returnType_6_0= ruleJvmTypeReference ) ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3439:1: ( (otherlv_0= '(' ( ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )* )? otherlv_4= ')' )? otherlv_5= '=>' ( (lv_returnType_6_0= ruleJvmTypeReference ) ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3439:1: ( (otherlv_0= '(' ( ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )* )? otherlv_4= ')' )? otherlv_5= '=>' ( (lv_returnType_6_0= ruleJvmTypeReference ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3439:2: (otherlv_0= '(' ( ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )* )? otherlv_4= ')' )? otherlv_5= '=>' ( (lv_returnType_6_0= ruleJvmTypeReference ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3439:2: (otherlv_0= '(' ( ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )* )? otherlv_4= ')' )?
            int alt62=2;
            ...
            switch (alt62) {
                case 1 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3439:4: otherlv_0= '(' ( ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )* )? otherlv_4= ')'
                    {
                    otherlv_0=(Token)match(input,42,FOLLOW_42_in_ruleXFunctionTypeRef8290); if (state.failed) return current;
                    if ( state.backtracking==0 ) {

                          	newLeafNode(otherlv_0, grammarAccess.getXFunctionTypeRefAccess().getLeftParenthesisKeyword_0_0());
                          
                    }
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3443:1: ( ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )* )?
                    int alt61=2;
                    int LA61_0 = input.LA(1);

                    if ( (LA61_0==RULE_ID||LA61_0==42||LA61_0==56) ) {
                        alt61=1;
                    }
                    switch (alt61) {
                        case 1 :
                            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3443:2: ( (lv_paramTypes_1_0= ruleJvmTypeReference ) ) (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )*
                            {
                            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3443:2: ( (lv_paramTypes_1_0= ruleJvmTypeReference ) )
                            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3444:1: (lv_paramTypes_1_0= ruleJvmTypeReference )
                            {
                            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3444:1: (lv_paramTypes_1_0= ruleJvmTypeReference )
                            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3445:3: lv_paramTypes_1_0= ruleJvmTypeReference
                            {
                            if ( state.backtracking==0 ) {
                            ...
                            pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleXFunctionTypeRef8312);
                            ...
                            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3461:2: (otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) ) )*
                            loop60:
                            do {
                                int alt60=2;
                                ...
                                switch (alt60) {
                            	case 1 :
                            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3461:4: otherlv_2= ',' ( (lv_paramTypes_3_0= ruleJvmTypeReference ) )
                            	    {
                            	    otherlv_2=(Token)match(input,41,FOLLOW_41_in_ruleXFunctionTypeRef8325); if (state.failed) return current;
                            	    if ( state.backtracking==0 ) {

                            	          	newLeafNode(otherlv_2, grammarAccess.getXFunctionTypeRefAccess().getCommaKeyword_0_1_1_0());
                            	          
                            	    }
                            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3465:1: ( (lv_paramTypes_3_0= ruleJvmTypeReference ) )
                            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3466:1: (lv_paramTypes_3_0= ruleJvmTypeReference )
                            	    {
                            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3466:1: (lv_paramTypes_3_0= ruleJvmTypeReference )
                            	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3467:3: lv_paramTypes_3_0= ruleJvmTypeReference
                            	    {
                            	    if ( state.backtracking==0 ) {
                            	    ...
                            	    pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleXFunctionTypeRef8346);
                    ...
                    otherlv_4=(Token)match(input,43,FOLLOW_43_in_ruleXFunctionTypeRef8362); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
            ...
            otherlv_5=(Token)match(input,56,FOLLOW_56_in_ruleXFunctionTypeRef8376); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_5, grammarAccess.getXFunctionTypeRefAccess().getEqualsSignGreaterThanSignKeyword_1());
                  
            }
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3491:1: ( (lv_returnType_6_0= ruleJvmTypeReference ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3492:1: (lv_returnType_6_0= ruleJvmTypeReference )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3492:1: (lv_returnType_6_0= ruleJvmTypeReference )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3493:3: lv_returnType_6_0= ruleJvmTypeReference
            {
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleXFunctionTypeRef8397);
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3517:1: entryRuleJvmParameterizedTypeReference returns [EObject current=null] : iv_ruleJvmParameterizedTypeReference= ruleJvmParameterizedTypeReference EOF ;
    public final EObject entryRuleJvmParameterizedTypeReference() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3518:2: (iv_ruleJvmParameterizedTypeReference= ruleJvmParameterizedTypeReference EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3519:2: iv_ruleJvmParameterizedTypeReference= ruleJvmParameterizedTypeReference EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getJvmParameterizedTypeReferenceRule()); 
            }
            pushFollow(FOLLOW_ruleJvmParameterizedTypeReference_in_entryRuleJvmParameterizedTypeReference8433);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleJvmParameterizedTypeReference8443); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3526:1: ruleJvmParameterizedTypeReference returns [EObject current=null] : ( ( ( ruleQualifiedName ) ) ( ( ( '<' )=>otherlv_1= '<' ) ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) ) (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )* otherlv_5= '>' )? ) ;
    public final EObject ruleJvmParameterizedTypeReference() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3529:28: ( ( ( ( ruleQualifiedName ) ) ( ( ( '<' )=>otherlv_1= '<' ) ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) ) (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )* otherlv_5= '>' )? ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3530:1: ( ( ( ruleQualifiedName ) ) ( ( ( '<' )=>otherlv_1= '<' ) ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) ) (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )* otherlv_5= '>' )? )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3530:1: ( ( ( ruleQualifiedName ) ) ( ( ( '<' )=>otherlv_1= '<' ) ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) ) (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )* otherlv_5= '>' )? )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3530:2: ( ( ruleQualifiedName ) ) ( ( ( '<' )=>otherlv_1= '<' ) ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) ) (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )* otherlv_5= '>' )?
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3530:2: ( ( ruleQualifiedName ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3531:1: ( ruleQualifiedName )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3531:1: ( ruleQualifiedName )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3532:3: ruleQualifiedName
            {
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleQualifiedName_in_ruleJvmParameterizedTypeReference8491);
            ruleQualifiedName();
            ...
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3545:2: ( ( ( '<' )=>otherlv_1= '<' ) ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) ) (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )* otherlv_5= '>' )?
            int alt64=2;
            alt64 = dfa64.predict(input);
            switch (alt64) {
                case 1 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3545:3: ( ( '<' )=>otherlv_1= '<' ) ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) ) (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )* otherlv_5= '>'
                    {
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3545:3: ( ( '<' )=>otherlv_1= '<' )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3545:4: ( '<' )=>otherlv_1= '<'
                    {
                    otherlv_1=(Token)match(input,30,FOLLOW_30_in_ruleJvmParameterizedTypeReference8512); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
                    ...
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3550:2: ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3551:1: (lv_arguments_2_0= ruleJvmArgumentTypeReference )
                    {
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3551:1: (lv_arguments_2_0= ruleJvmArgumentTypeReference )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3552:3: lv_arguments_2_0= ruleJvmArgumentTypeReference
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleJvmArgumentTypeReference_in_ruleJvmParameterizedTypeReference8534);
                    ...
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3568:2: (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )*
                    loop63:
                    do {
                        int alt63=2;
                        ...
                        switch (alt63) {
                    	case 1 :
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3568:4: otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) )
                    	    {
                    	    otherlv_3=(Token)match(input,41,FOLLOW_41_in_ruleJvmParameterizedTypeReference8547); if (state.failed) return current;
                    	    if ( state.backtracking==0 ) {

                    	          	newLeafNode(otherlv_3, grammarAccess.getJvmParameterizedTypeReferenceAccess().getCommaKeyword_1_2_0());
                    	          
                    	    }
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3572:1: ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) )
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3573:1: (lv_arguments_4_0= ruleJvmArgumentTypeReference )
                    	    {
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3573:1: (lv_arguments_4_0= ruleJvmArgumentTypeReference )
                    	    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3574:3: lv_arguments_4_0= ruleJvmArgumentTypeReference
                    	    {
                    	    if ( state.backtracking==0 ) {
                    	    ...
                    	    pushFollow(FOLLOW_ruleJvmArgumentTypeReference_in_ruleJvmParameterizedTypeReference8568);
                    ...
                    otherlv_5=(Token)match(input,29,FOLLOW_29_in_ruleJvmParameterizedTypeReference8582); if (state.failed) return current;
                    if ( state.backtracking==0 ) {
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3602:1: entryRuleJvmArgumentTypeReference returns [EObject current=null] : iv_ruleJvmArgumentTypeReference= ruleJvmArgumentTypeReference EOF ;
    public final EObject entryRuleJvmArgumentTypeReference() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3603:2: (iv_ruleJvmArgumentTypeReference= ruleJvmArgumentTypeReference EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3604:2: iv_ruleJvmArgumentTypeReference= ruleJvmArgumentTypeReference EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getJvmArgumentTypeReferenceRule()); 
            }
            pushFollow(FOLLOW_ruleJvmArgumentTypeReference_in_entryRuleJvmArgumentTypeReference8620);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleJvmArgumentTypeReference8630); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3611:1: ruleJvmArgumentTypeReference returns [EObject current=null] : (this_JvmTypeReference_0= ruleJvmTypeReference | this_JvmWildcardTypeReference_1= ruleJvmWildcardTypeReference ) ;
    public final EObject ruleJvmArgumentTypeReference() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3614:28: ( (this_JvmTypeReference_0= ruleJvmTypeReference | this_JvmWildcardTypeReference_1= ruleJvmWildcardTypeReference ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3615:1: (this_JvmTypeReference_0= ruleJvmTypeReference | this_JvmWildcardTypeReference_1= ruleJvmWildcardTypeReference )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3615:1: (this_JvmTypeReference_0= ruleJvmTypeReference | this_JvmWildcardTypeReference_1= ruleJvmWildcardTypeReference )
            int alt65=2;
            int LA65_0 = input.LA(1);

            if ( (LA65_0==RULE_ID||LA65_0==42||LA65_0==56) ) {
                alt65=1;
            }
            else if ( (LA65_0==57) ) {
                alt65=2;
            ...
            switch (alt65) {
                case 1 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3616:5: this_JvmTypeReference_0= ruleJvmTypeReference
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleJvmArgumentTypeReference8677);
                    ...
                    break;
                case 2 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3626:5: this_JvmWildcardTypeReference_1= ruleJvmWildcardTypeReference
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleJvmWildcardTypeReference_in_ruleJvmArgumentTypeReference8704);
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3642:1: entryRuleJvmWildcardTypeReference returns [EObject current=null] : iv_ruleJvmWildcardTypeReference= ruleJvmWildcardTypeReference EOF ;
    public final EObject entryRuleJvmWildcardTypeReference() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3643:2: (iv_ruleJvmWildcardTypeReference= ruleJvmWildcardTypeReference EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3644:2: iv_ruleJvmWildcardTypeReference= ruleJvmWildcardTypeReference EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getJvmWildcardTypeReferenceRule()); 
            }
            pushFollow(FOLLOW_ruleJvmWildcardTypeReference_in_entryRuleJvmWildcardTypeReference8739);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleJvmWildcardTypeReference8749); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3651:1: ruleJvmWildcardTypeReference returns [EObject current=null] : ( () otherlv_1= '?' ( ( (lv_constraints_2_0= ruleJvmUpperBound ) ) | ( (lv_constraints_3_0= ruleJvmLowerBound ) ) )? ) ;
    public final EObject ruleJvmWildcardTypeReference() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3654:28: ( ( () otherlv_1= '?' ( ( (lv_constraints_2_0= ruleJvmUpperBound ) ) | ( (lv_constraints_3_0= ruleJvmLowerBound ) ) )? ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3655:1: ( () otherlv_1= '?' ( ( (lv_constraints_2_0= ruleJvmUpperBound ) ) | ( (lv_constraints_3_0= ruleJvmLowerBound ) ) )? )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3655:1: ( () otherlv_1= '?' ( ( (lv_constraints_2_0= ruleJvmUpperBound ) ) | ( (lv_constraints_3_0= ruleJvmLowerBound ) ) )? )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3655:2: () otherlv_1= '?' ( ( (lv_constraints_2_0= ruleJvmUpperBound ) ) | ( (lv_constraints_3_0= ruleJvmLowerBound ) ) )?
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3655:2: ()
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3656:5: 
            {
            if ( state.backtracking==0 ) {
            ...
            otherlv_1=(Token)match(input,57,FOLLOW_57_in_ruleJvmWildcardTypeReference8795); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_1, grammarAccess.getJvmWildcardTypeReferenceAccess().getQuestionMarkKeyword_1());
                  
            }
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3665:1: ( ( (lv_constraints_2_0= ruleJvmUpperBound ) ) | ( (lv_constraints_3_0= ruleJvmLowerBound ) ) )?
            int alt66=3;
            ...
            switch (alt66) {
                case 1 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3665:2: ( (lv_constraints_2_0= ruleJvmUpperBound ) )
                    {
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3665:2: ( (lv_constraints_2_0= ruleJvmUpperBound ) )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3666:1: (lv_constraints_2_0= ruleJvmUpperBound )
                    {
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3666:1: (lv_constraints_2_0= ruleJvmUpperBound )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3667:3: lv_constraints_2_0= ruleJvmUpperBound
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleJvmUpperBound_in_ruleJvmWildcardTypeReference8817);
                    ...
                    break;
                case 2 :
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3684:6: ( (lv_constraints_3_0= ruleJvmLowerBound ) )
                    {
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3684:6: ( (lv_constraints_3_0= ruleJvmLowerBound ) )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3685:1: (lv_constraints_3_0= ruleJvmLowerBound )
                    {
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3685:1: (lv_constraints_3_0= ruleJvmLowerBound )
                    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3686:3: lv_constraints_3_0= ruleJvmLowerBound
                    {
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ruleJvmLowerBound_in_ruleJvmWildcardTypeReference8844);
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3710:1: entryRuleJvmUpperBound returns [EObject current=null] : iv_ruleJvmUpperBound= ruleJvmUpperBound EOF ;
    public final EObject entryRuleJvmUpperBound() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3711:2: (iv_ruleJvmUpperBound= ruleJvmUpperBound EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3712:2: iv_ruleJvmUpperBound= ruleJvmUpperBound EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getJvmUpperBoundRule()); 
            }
            pushFollow(FOLLOW_ruleJvmUpperBound_in_entryRuleJvmUpperBound8882);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleJvmUpperBound8892); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3719:1: ruleJvmUpperBound returns [EObject current=null] : (otherlv_0= 'extends' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) ) ;
    public final EObject ruleJvmUpperBound() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3722:28: ( (otherlv_0= 'extends' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3723:1: (otherlv_0= 'extends' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3723:1: (otherlv_0= 'extends' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3723:3: otherlv_0= 'extends' ( (lv_typeReference_1_0= ruleJvmTypeReference ) )
            {
            otherlv_0=(Token)match(input,58,FOLLOW_58_in_ruleJvmUpperBound8929); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_0, grammarAccess.getJvmUpperBoundAccess().getExtendsKeyword_0());
                  
            }
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3727:1: ( (lv_typeReference_1_0= ruleJvmTypeReference ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3728:1: (lv_typeReference_1_0= ruleJvmTypeReference )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3728:1: (lv_typeReference_1_0= ruleJvmTypeReference )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3729:3: lv_typeReference_1_0= ruleJvmTypeReference
            {
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleJvmUpperBound8950);
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3753:1: entryRuleJvmUpperBoundAnded returns [EObject current=null] : iv_ruleJvmUpperBoundAnded= ruleJvmUpperBoundAnded EOF ;
    public final EObject entryRuleJvmUpperBoundAnded() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3754:2: (iv_ruleJvmUpperBoundAnded= ruleJvmUpperBoundAnded EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3755:2: iv_ruleJvmUpperBoundAnded= ruleJvmUpperBoundAnded EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getJvmUpperBoundAndedRule()); 
            }
            pushFollow(FOLLOW_ruleJvmUpperBoundAnded_in_entryRuleJvmUpperBoundAnded8986);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleJvmUpperBoundAnded8996); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3762:1: ruleJvmUpperBoundAnded returns [EObject current=null] : (otherlv_0= '&' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) ) ;
    public final EObject ruleJvmUpperBoundAnded() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3765:28: ( (otherlv_0= '&' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3766:1: (otherlv_0= '&' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3766:1: (otherlv_0= '&' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3766:3: otherlv_0= '&' ( (lv_typeReference_1_0= ruleJvmTypeReference ) )
            {
            otherlv_0=(Token)match(input,59,FOLLOW_59_in_ruleJvmUpperBoundAnded9033); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_0, grammarAccess.getJvmUpperBoundAndedAccess().getAmpersandKeyword_0());
                  
            }
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3770:1: ( (lv_typeReference_1_0= ruleJvmTypeReference ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3771:1: (lv_typeReference_1_0= ruleJvmTypeReference )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3771:1: (lv_typeReference_1_0= ruleJvmTypeReference )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3772:3: lv_typeReference_1_0= ruleJvmTypeReference
            {
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleJvmUpperBoundAnded9054);
            lv_typeReference_1_0=ruleJvmTypeReference();
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3796:1: entryRuleJvmLowerBound returns [EObject current=null] : iv_ruleJvmLowerBound= ruleJvmLowerBound EOF ;
    public final EObject entryRuleJvmLowerBound() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3797:2: (iv_ruleJvmLowerBound= ruleJvmLowerBound EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3798:2: iv_ruleJvmLowerBound= ruleJvmLowerBound EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getJvmLowerBoundRule()); 
            }
            pushFollow(FOLLOW_ruleJvmLowerBound_in_entryRuleJvmLowerBound9090);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleJvmLowerBound9100); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3805:1: ruleJvmLowerBound returns [EObject current=null] : (otherlv_0= 'super' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) ) ;
    public final EObject ruleJvmLowerBound() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3808:28: ( (otherlv_0= 'super' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3809:1: (otherlv_0= 'super' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3809:1: (otherlv_0= 'super' ( (lv_typeReference_1_0= ruleJvmTypeReference ) ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3809:3: otherlv_0= 'super' ( (lv_typeReference_1_0= ruleJvmTypeReference ) )
            {
            otherlv_0=(Token)match(input,53,FOLLOW_53_in_ruleJvmLowerBound9137); if (state.failed) return current;
            if ( state.backtracking==0 ) {

                  	newLeafNode(otherlv_0, grammarAccess.getJvmLowerBoundAccess().getSuperKeyword_0());
                  
            }
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3813:1: ( (lv_typeReference_1_0= ruleJvmTypeReference ) )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3814:1: (lv_typeReference_1_0= ruleJvmTypeReference )
            {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3814:1: (lv_typeReference_1_0= ruleJvmTypeReference )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3815:3: lv_typeReference_1_0= ruleJvmTypeReference
            {
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_ruleJvmTypeReference_in_ruleJvmLowerBound9158);
            lv_typeReference_1_0=ruleJvmTypeReference();
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3841:1: entryRuleValidID returns [String current=null] : iv_ruleValidID= ruleValidID EOF ;
    public final String entryRuleValidID() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3842:2: (iv_ruleValidID= ruleValidID EOF )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3843:2: iv_ruleValidID= ruleValidID EOF
            {
            if ( state.backtracking==0 ) {
               newCompositeNode(grammarAccess.getValidIDRule()); 
            }
            pushFollow(FOLLOW_ruleValidID_in_entryRuleValidID9197);
            ...
            match(input,EOF,FOLLOW_EOF_in_entryRuleValidID9208); if (state.failed) return current;
    ...
    // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3850:1: ruleValidID returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : this_ID_0= RULE_ID ;
    public final AntlrDatatypeRuleToken ruleValidID() throws RecognitionException {
        ...
        try {
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3853:28: (this_ID_0= RULE_ID )
            // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3854:5: this_ID_0= RULE_ID
            {
            this_ID_0=(Token)match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleValidID9247); if (state.failed) return current;
            if ( state.backtracking==0 ) {
    ...
    public final void synpred9_InternalEL_fragment() throws RecognitionException {   
        ...
        match(input,38,FOLLOW_38_in_synpred9_InternalEL4431); if (state.failed) return ;
    ...
    public final void synpred10_InternalEL_fragment() throws RecognitionException {   
        ...
        match(input,19,FOLLOW_19_in_synpred10_InternalEL4585); if (state.failed) return ;
    ...
    public final void synpred11_InternalEL_fragment() throws RecognitionException {   
        ...
        switch (alt67) {
            case 1 :
                ...
                {
                match(input,19,FOLLOW_19_in_synpred11_InternalEL4703); if (state.failed) return ;
            ...
            case 2 :
                ...
                {
                match(input,39,FOLLOW_39_in_synpred11_InternalEL4717); if (state.failed) return ;
            ...
            case 3 :
                ...
                {
                match(input,40,FOLLOW_40_in_synpred11_InternalEL4737); if (state.failed) return ;
    ...
    public final void synpred12_InternalEL_fragment() throws RecognitionException {   
        ...
        {
        match(input,42,FOLLOW_42_in_synpred12_InternalEL4964); if (state.failed) return ;
    ...
    public final void synpred13_InternalEL_fragment() throws RecognitionException {   
        ...
        if ( (LA69_0==RULE_ID||LA69_0==42||LA69_0==56) ) {
            alt69=1;
        }
        switch (alt69) {
            case 1 :
                ...
                do {
                	...
                	case 1 :
                	    ...
                	    {
                	    match(input,41,FOLLOW_41_in_synpred13_InternalEL5023); if (state.failed) return ;
        ...
        {
        match(input,45,FOLLOW_45_in_synpred13_InternalEL5044); if (state.failed) return ;
    ...
    public final void synpred14_InternalEL_fragment() throws RecognitionException {   
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2054:4: ( ( ruleXClosure ) )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2055:1: ( ruleXClosure )
        {
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2055:1: ( ruleXClosure )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2056:1: ruleXClosure
        {
        pushFollow(FOLLOW_ruleXClosure_in_synpred14_InternalEL5162);
        ruleXClosure();
    ...
    // $ANTLR start synpred15_InternalEL
    public final void synpred15_InternalEL_fragment() throws RecognitionException {   
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2107:2: ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2107:3: ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) )
        {
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2107:3: ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) )
        ...
        if ( (LA71_0==RULE_ID||LA71_0==42||LA71_0==56) ) {
            alt71=1;
        }
        switch (alt71) {
            case 1 :
                ...
                {
                // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:2107:5: ( ( ruleJvmFormalParameter ) )
                ...
                {
                pushFollow(FOLLOW_ruleJvmFormalParameter_in_synpred15_InternalEL5292);
                ruleJvmFormalParameter();
                ...
                do {
                	...
                	case 1 :
                	    ...
                	    {
                	    match(input,41,FOLLOW_41_in_synpred15_InternalEL5299); if (state.failed) return ;
                	    ...
                	    {
                	    pushFollow(FOLLOW_ruleJvmFormalParameter_in_synpred15_InternalEL5306);
                	    ruleJvmFormalParameter();
        ...
        {
        match(input,45,FOLLOW_45_in_synpred15_InternalEL5320); if (state.failed) return ;
    ...
    // $ANTLR end synpred15_InternalEL

    // $ANTLR start synpred17_InternalEL
    public final void synpred17_InternalEL_fragment() throws RecognitionException {   
        ...
        {
        match(input,49,FOLLOW_49_in_synpred17_InternalEL6103); if (state.failed) return ;

        }
    }
    // $ANTLR end synpred17_InternalEL
    ...
    public final void synpred18_InternalEL_fragment() throws RecognitionException {   
        ...
        {
        pushFollow(FOLLOW_ruleJvmTypeReference_in_synpred18_InternalEL6574);
        ...
        {
        pushFollow(FOLLOW_ruleValidID_in_synpred18_InternalEL6583);
        ruleValidID();
    ...
    public final void synpred19_InternalEL_fragment() throws RecognitionException {   
        ...
        {
        match(input,42,FOLLOW_42_in_synpred19_InternalEL7145); if (state.failed) return ;
    ...
    public final void synpred20_InternalEL_fragment() throws RecognitionException {   
        ...
        if ( (LA75_0==RULE_ID||LA75_0==42||LA75_0==56) ) {
            alt75=1;
        }
        switch (alt75) {
            case 1 :
                ...
                {
                pushFollow(FOLLOW_ruleJvmFormalParameter_in_synpred20_InternalEL7197);
                ruleJvmFormalParameter();
                ...
                do {
                	...
                	case 1 :
                	    ...
                	    {
                	    match(input,41,FOLLOW_41_in_synpred20_InternalEL7204); if (state.failed) return ;
                	    ...
                	    {
                	    pushFollow(FOLLOW_ruleJvmFormalParameter_in_synpred20_InternalEL7211);
                	    ruleJvmFormalParameter();
        ...
        {
        match(input,45,FOLLOW_45_in_synpred20_InternalEL7225); if (state.failed) return ;
    ...
    public final void synpred21_InternalEL_fragment() throws RecognitionException {   
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3084:4: ( ( ruleXClosure ) )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3085:1: ( ruleXClosure )
        {
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3085:1: ( ruleXClosure )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3086:1: ruleXClosure
        {
        pushFollow(FOLLOW_ruleXClosure_in_synpred21_InternalEL7343);
        ruleXClosure();
    ...
    // $ANTLR start synpred23_InternalEL
    public final void synpred23_InternalEL_fragment() throws RecognitionException {   
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3342:3: ( '.' )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3343:2: '.'
        {
        match(input,19,FOLLOW_19_in_synpred23_InternalEL7988); if (state.failed) return ;

        }
    }
    // $ANTLR end synpred23_InternalEL

    // $ANTLR start synpred24_InternalEL
    public final void synpred24_InternalEL_fragment() throws RecognitionException {   
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3391:2: ( ( () '[' ']' ) )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3391:3: ( () '[' ']' )
        {
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3391:3: ( () '[' ']' )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3391:4: () '[' ']'
        {
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3391:4: ()
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3392:1: 
        {
        }

        match(input,44,FOLLOW_44_in_synpred24_InternalEL8140); if (state.failed) return ;
        match(input,46,FOLLOW_46_in_synpred24_InternalEL8144); if (state.failed) return ;
    ...
    public final void synpred25_InternalEL_fragment() throws RecognitionException {   
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3545:4: ( '<' )
        // ../ch.vorburger.el/src-gen/ch/vorburger/el/parser/antlr/internal/InternalEL.g:3545:6: '<'
        {
        match(input,30,FOLLOW_30_in_synpred25_InternalEL8504); if (state.failed) return ;
    ...
    public final boolean synpred15_InternalEL() {
        state.backtracking++;
        int start = input.mark();
        try {
            synpred15_InternalEL_fragment(); // can never throw exception
        } catch (RecognitionException re) {
            System.err.println("impossible: "+re);
        }
        boolean success = !state.failed;
    ...
    public final boolean synpred23_InternalEL() {
        state.backtracking++;
        int start = input.mark();
        try {
            synpred23_InternalEL_fragment(); // can never throw exception
        } catch (RecognitionException re) {
            System.err.println("impossible: "+re);
        }
        boolean success = !state.failed;
    ...
    public final boolean synpred17_InternalEL() {
        state.backtracking++;
        int start = input.mark();
        try {
            synpred17_InternalEL_fragment(); // can never throw exception
        } catch (RecognitionException re) {
            System.err.println("impossible: "+re);
        }
        boolean success = !state.failed;
    ...
    static final String DFA4_maxS =
        "\1\22\3\uffff\1\65\1\uffff\1\36\1\65\1\36\1\65\1\uffff\1\65\1\uffff";
    static final String DFA4_acceptS =
        "\1\uffff\1\1\1\2\1\3\1\uffff\1\4\4\uffff\1\5\1\uffff\1\6";
    static final String DFA4_specialS =
        "\15\uffff}>";
    static final String[] DFA4_transitionS = {
            "\1\4\1\5\1\3\6\uffff\2\2\4\1",
            "",
            "",
            "",
            "\4\5\4\uffff\7\5\1\6\1\5\1\uffff\26\5\2\uffff\4\5\1\uffff"+
            "\3\5",
            "",
            "\1\7\1\5\1\uffff\1\5\26\uffff\1\5",
            "\4\5\4\uffff\7\5\1\10\1\5\1\uffff\26\5\2\uffff\4\5\1\uffff"+
            "\3\5",
            "\1\11\2\uffff\1\5\26\uffff\1\5",
            "\1\13\3\12\4\uffff\11\12\1\uffff\26\12\2\uffff\4\12\1\uffff"+
            "\3\12",
            "",
            "\4\12\4\uffff\10\12\1\14\2\uffff\22\12\1\uffff\1\12\3\uffff"+
            "\3\12\2\uffff\3\12",
            ""
    };
    ...
    static final String[] DFA30_transitionS = {
            "\4\2\4\uffff\11\2\1\uffff\24\2\1\1\2\2\1\uffff\4\2\1\uffff"+
            "\3\2",
            "\1\uffff",
            "",
            "",
    ...
    static final String[] DFA29_transitionS = {
            "\3\5\1\1\5\uffff\6\5\13\uffff\3\5\4\uffff\1\5\4\uffff\1\2\1"+
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( (LA29_0==42) ) {s = 2;}

                        else if ( (LA29_0==56) && (synpred13_InternalEL())) {s = 3;}

                        else if ( (LA29_0==45) && (synpred13_InternalEL())) {s = 4;}

                        else if ( ((LA29_0>=RULE_INT && LA29_0<=RULE_STRING)||(LA29_0>=13 && LA29_0<=18)||(LA29_0>=30 && LA29_0<=32)||LA29_0==37||LA29_0==48||LA29_0==53) ) {s = 5;}

                        else if ( (LA29_0==43) ) {s = 20;}
    ...
    static final String[] DFA35_transitionS = {
            "\3\5\1\1\5\uffff\6\5\13\uffff\3\5\4\uffff\1\5\4\uffff\1\2\2"+
    ...
    class DFA35 extends DFA {
        ...
        public String getDescription() {
            return "2107:1: ( ( ( ( ( ( ruleJvmFormalParameter ) ) ( ',' ( ( ruleJvmFormalParameter ) ) )* )? ( ( '|' ) ) ) )=> ( ( ( (lv_declaredFormalParameters_2_0= ruleJvmFormalParameter ) ) (otherlv_3= ',' ( (lv_declaredFormalParameters_4_0= ruleJvmFormalParameter ) ) )* )? ( (lv_explicitSyntax_5_0= '|' ) ) ) )?";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            TokenStream input = (TokenStream)_input;
        	int _s = s;
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( (LA35_0==56) && (synpred15_InternalEL())) {s = 3;}

                        else if ( (LA35_0==45) && (synpred15_InternalEL())) {s = 4;}

                        else if ( ((LA35_0>=RULE_INT && LA35_0<=RULE_STRING)||(LA35_0>=13 && LA35_0<=18)||(LA35_0>=30 && LA35_0<=32)||LA35_0==37||LA35_0==46||LA35_0==48||(LA35_0>=51 && LA35_0<=53)) ) {s = 5;}
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( (LA52_0==56) && (synpred20_InternalEL())) {s = 3;}

                        else if ( (LA52_0==45) && (synpred20_InternalEL())) {s = 4;}

                        else if ( ((LA52_0>=RULE_INT && LA52_0<=RULE_STRING)||(LA52_0>=13 && LA52_0<=18)||(LA52_0>=30 && LA52_0<=32)||LA52_0==37||LA52_0==48||LA52_0==53) ) {s = 5;}

                        else if ( (LA52_0==43) ) {s = 20;}
    ...
    static final String[] DFA64_transitionS = {
            "\4\2\4\uffff\11\2\1\uffff\10\2\1\1\16\2\1\uffff\10\2",
            "\1\uffff",
            "",
            "",
            "",
    ...
    class DFA64 extends DFA {
        ...
        public String getDescription() {
            return "3545:2: ( ( ( '<' )=>otherlv_1= '<' ) ( (lv_arguments_2_0= ruleJvmArgumentTypeReference ) ) (otherlv_3= ',' ( (lv_arguments_4_0= ruleJvmArgumentTypeReference ) ) )* otherlv_5= '>' )?";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            TokenStream input = (TokenStream)_input;
        	int _s = s;
    ...
    public static final BitSet FOLLOW_ruleXOtherOperatorExpression_in_ruleXRelationalExpression395 = new BitSet(new long[]{0x0000000078000002L});
    public static final BitSet FOLLOW_ruleOpCompare_in_ruleXRelationalExpression448 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXOtherOperatorExpression_in_ruleXRelationalExpression471 = new BitSet(new long[]{0x0000000078000002L});
    ...
    public static final BitSet FOLLOW_ruleXAdditiveExpression_in_ruleXOtherOperatorExpression566 = new BitSet(new long[]{0x0000000000001002L});
    public static final BitSet FOLLOW_ruleOpOther_in_ruleXOtherOperatorExpression619 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXAdditiveExpression_in_ruleXOtherOperatorExpression642 = new BitSet(new long[]{0x0000000000001002L});
    ...
    public static final BitSet FOLLOW_12_in_ruleOpOther729 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_13_in_ruleXNullLiteral1355 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_14_in_ruleXNullLiteral1373 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_15_in_ruleXBooleanLiteral1468 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_16_in_ruleXBooleanLiteral1486 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_17_in_ruleXBooleanLiteral1513 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_18_in_ruleXBooleanLiteral1542 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_RULE_INT_in_ruleDate1647 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_ruleDate1665 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_INT_in_ruleDate1680 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_ruleDate1698 = new BitSet(new long[]{0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_RULE_INT_in_ruleDate_Time1837 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleDate_Time1855 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_INT_in_ruleDate_Time1870 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleDate_Time1888 = new BitSet(new long[]{0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_RULE_INT_in_ruleNumber2001 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_ruleNumber2019 = new BitSet(new long[]{0x0000000000000030L});
    ...
    public static final BitSet FOLLOW_ruleValidID_in_ruleXAssignment2177 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_ruleOpSingleAssign_in_ruleXAssignment2193 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXAssignment_in_ruleXAssignment2213 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXOrExpression_in_ruleXAssignment2243 = new BitSet(new long[]{0x0000000000400002L});
    public static final BitSet FOLLOW_ruleOpMultiAssign_in_ruleXAssignment2296 = new BitSet(new long[]{0x00210421C007E0F0L});
    ...
    public static final BitSet FOLLOW_21_in_ruleOpSingleAssign2407 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_22_in_ruleOpMultiAssign2495 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleXAndExpression_in_ruleXOrExpression2591 = new BitSet(new long[]{0x0000000000800002L});
    public static final BitSet FOLLOW_ruleOpOr_in_ruleXOrExpression2644 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXAndExpression_in_ruleXOrExpression2667 = new BitSet(new long[]{0x0000000000800002L});
    ...
    public static final BitSet FOLLOW_23_in_ruleOpOr2754 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleXEqualityExpression_in_ruleXAndExpression2850 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_ruleOpAnd_in_ruleXAndExpression2903 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXEqualityExpression_in_ruleXAndExpression2926 = new BitSet(new long[]{0x0000000001000002L});
    ...
    public static final BitSet FOLLOW_24_in_ruleOpAnd3013 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleXRelationalExpression_in_ruleXEqualityExpression3109 = new BitSet(new long[]{0x0000000006000002L});
    public static final BitSet FOLLOW_ruleOpEquality_in_ruleXEqualityExpression3162 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXRelationalExpression_in_ruleXEqualityExpression3185 = new BitSet(new long[]{0x0000000006000002L});
    ...
    public static final BitSet FOLLOW_25_in_ruleOpEquality3273 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_26_in_ruleOpEquality3292 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_27_in_ruleOpCompare3382 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_28_in_ruleOpCompare3401 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_29_in_ruleOpCompare3420 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_30_in_ruleOpCompare3439 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleXMultiplicativeExpression_in_ruleXAdditiveExpression3536 = new BitSet(new long[]{0x0000000180000002L});
    public static final BitSet FOLLOW_ruleOpAdd_in_ruleXAdditiveExpression3589 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXMultiplicativeExpression_in_ruleXAdditiveExpression3612 = new BitSet(new long[]{0x0000000180000002L});
    ...
    public static final BitSet FOLLOW_31_in_ruleOpAdd3700 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_32_in_ruleOpAdd3719 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleXUnaryOperation_in_ruleXMultiplicativeExpression3816 = new BitSet(new long[]{0x0000001E00000002L});
    public static final BitSet FOLLOW_ruleOpMulti_in_ruleXMultiplicativeExpression3869 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXUnaryOperation_in_ruleXMultiplicativeExpression3892 = new BitSet(new long[]{0x0000001E00000002L});
    ...
    public static final BitSet FOLLOW_33_in_ruleOpMulti3980 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_34_in_ruleOpMulti3999 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_35_in_ruleOpMulti4018 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_36_in_ruleOpMulti4037 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleOpUnary_in_ruleXUnaryOperation4145 = new BitSet(new long[]{0x00210421C007E0F0L});
    ...
    public static final BitSet FOLLOW_37_in_ruleOpUnary4280 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_32_in_ruleOpUnary4299 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_31_in_ruleOpUnary4318 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleXMemberFeatureCall_in_ruleXCastedExpression4415 = new BitSet(new long[]{0x0000004000000002L});
    public static final BitSet FOLLOW_38_in_ruleXCastedExpression4450 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleXCastedExpression4473 = new BitSet(new long[]{0x0000004000000002L});
    ...
    public static final BitSet FOLLOW_ruleXPrimaryExpression_in_ruleXMemberFeatureCall4568 = new BitSet(new long[]{0x0000018000080002L});
    public static final BitSet FOLLOW_19_in_ruleXMemberFeatureCall4617 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleXMemberFeatureCall4640 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_ruleOpSingleAssign_in_ruleXMemberFeatureCall4656 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXAssignment_in_ruleXMemberFeatureCall4678 = new BitSet(new long[]{0x0000018000080002L});
    public static final BitSet FOLLOW_19_in_ruleXMemberFeatureCall4764 = new BitSet(new long[]{0x0000000040000080L});
    public static final BitSet FOLLOW_39_in_ruleXMemberFeatureCall4788 = new BitSet(new long[]{0x0000000040000080L});
    public static final BitSet FOLLOW_40_in_ruleXMemberFeatureCall4825 = new BitSet(new long[]{0x0000000040000080L});
    public static final BitSet FOLLOW_30_in_ruleXMemberFeatureCall4854 = new BitSet(new long[]{0x0300040000000080L});
    public static final BitSet FOLLOW_ruleJvmArgumentTypeReference_in_ruleXMemberFeatureCall4875 = new BitSet(new long[]{0x0000020020000000L});
    public static final BitSet FOLLOW_41_in_ruleXMemberFeatureCall4888 = new BitSet(new long[]{0x0300040000000080L});
    public static final BitSet FOLLOW_ruleJvmArgumentTypeReference_in_ruleXMemberFeatureCall4909 = new BitSet(new long[]{0x0000020020000000L});
    public static final BitSet FOLLOW_29_in_ruleXMemberFeatureCall4923 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleXMemberFeatureCall4948 = new BitSet(new long[]{0x0000158000080002L});
    public static final BitSet FOLLOW_42_in_ruleXMemberFeatureCall4982 = new BitSet(new long[]{0x01212C21C007E0F0L});
    public static final BitSet FOLLOW_ruleXShortClosure_in_ruleXMemberFeatureCall5067 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXMemberFeatureCall5095 = new BitSet(new long[]{0x00000A0000000000L});
    public static final BitSet FOLLOW_41_in_ruleXMemberFeatureCall5108 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXMemberFeatureCall5129 = new BitSet(new long[]{0x00000A0000000000L});
    public static final BitSet FOLLOW_43_in_ruleXMemberFeatureCall5146 = new BitSet(new long[]{0x0000118000080002L});
    public static final BitSet FOLLOW_ruleXClosure_in_ruleXMemberFeatureCall5179 = new BitSet(new long[]{0x0000018000080002L});
    public static final BitSet FOLLOW_ruleXClosure_in_entryRuleXClosure5219 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXClosure5229 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_ruleXClosure5275 = new BitSet(new long[]{0x01396421C007E0F0L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_ruleXClosure5346 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_41_in_ruleXClosure5359 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_ruleXClosure5380 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_45_in_ruleXClosure5402 = new BitSet(new long[]{0x00394421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpressionInClosure_in_ruleXClosure5439 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_ruleXClosure5451 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXExpressionInClosure_in_entryRuleXExpressionInClosure5487 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXExpressionInClosure5497 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXExpressionInsideBlock_in_ruleXExpressionInClosure5553 = new BitSet(new long[]{0x00398421C007E0F2L});
    public static final BitSet FOLLOW_47_in_ruleXExpressionInClosure5566 = new BitSet(new long[]{0x00390421C007E0F2L});
    public static final BitSet FOLLOW_ruleXShortClosure_in_entryRuleXShortClosure5606 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXShortClosure5616 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_ruleXShortClosure5724 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_41_in_ruleXShortClosure5737 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_ruleXShortClosure5758 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_45_in_ruleXShortClosure5780 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXShortClosure5816 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXParenthesizedExpression_in_entryRuleXParenthesizedExpression5852 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXParenthesizedExpression5862 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_42_in_ruleXParenthesizedExpression5899 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXParenthesizedExpression5921 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_43_in_ruleXParenthesizedExpression5932 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXIfExpression_in_entryRuleXIfExpression5968 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXIfExpression5978 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_48_in_ruleXIfExpression6024 = new BitSet(new long[]{0x0000040000000000L});
    public static final BitSet FOLLOW_42_in_ruleXIfExpression6036 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXIfExpression6057 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_43_in_ruleXIfExpression6069 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXIfExpression6090 = new BitSet(new long[]{0x0002000000000002L});
    public static final BitSet FOLLOW_49_in_ruleXIfExpression6111 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXIfExpression6133 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXCasePart_in_entryRuleXCasePart6173 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXCasePart6183 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleXCasePart6229 = new BitSet(new long[]{0x0004000000100000L});
    public static final BitSet FOLLOW_50_in_ruleXCasePart6243 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXCasePart6264 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleXCasePart6278 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXCasePart6299 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXExpressionInsideBlock_in_entryRuleXExpressionInsideBlock6343 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXExpressionInsideBlock6353 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXVariableDeclaration_in_ruleXExpressionInsideBlock6400 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXExpressionInsideBlock6427 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXVariableDeclaration_in_entryRuleXVariableDeclaration6462 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXVariableDeclaration6472 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_51_in_ruleXVariableDeclaration6525 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_52_in_ruleXVariableDeclaration6556 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleXVariableDeclaration6604 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleXVariableDeclaration6625 = new BitSet(new long[]{0x0000000000200002L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleXVariableDeclaration6654 = new BitSet(new long[]{0x0000000000200002L});
    public static final BitSet FOLLOW_21_in_ruleXVariableDeclaration6668 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXVariableDeclaration6689 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_entryRuleJvmFormalParameter6727 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleJvmFormalParameter6737 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleJvmFormalParameter6783 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleJvmFormalParameter6805 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleFullJvmFormalParameter_in_entryRuleFullJvmFormalParameter6841 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleFullJvmFormalParameter6851 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleFullJvmFormalParameter6897 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleFullJvmFormalParameter6918 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXFeatureCall_in_entryRuleXFeatureCall6954 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXFeatureCall6964 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleStaticQualifier_in_ruleXFeatureCall7021 = new BitSet(new long[]{0x0020000040000080L});
    public static final BitSet FOLLOW_30_in_ruleXFeatureCall7035 = new BitSet(new long[]{0x0300040000000080L});
    public static final BitSet FOLLOW_ruleJvmArgumentTypeReference_in_ruleXFeatureCall7056 = new BitSet(new long[]{0x0000020020000000L});
    public static final BitSet FOLLOW_41_in_ruleXFeatureCall7069 = new BitSet(new long[]{0x0300040000000080L});
    public static final BitSet FOLLOW_ruleJvmArgumentTypeReference_in_ruleXFeatureCall7090 = new BitSet(new long[]{0x0000020020000000L});
    public static final BitSet FOLLOW_29_in_ruleXFeatureCall7104 = new BitSet(new long[]{0x0020000040000080L});
    public static final BitSet FOLLOW_ruleIdOrSuper_in_ruleXFeatureCall7129 = new BitSet(new long[]{0x0000140000000002L});
    public static final BitSet FOLLOW_42_in_ruleXFeatureCall7163 = new BitSet(new long[]{0x01212C21C007E0F0L});
    public static final BitSet FOLLOW_ruleXShortClosure_in_ruleXFeatureCall7248 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXFeatureCall7276 = new BitSet(new long[]{0x00000A0000000000L});
    public static final BitSet FOLLOW_41_in_ruleXFeatureCall7289 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXFeatureCall7310 = new BitSet(new long[]{0x00000A0000000000L});
    public static final BitSet FOLLOW_43_in_ruleXFeatureCall7327 = new BitSet(new long[]{0x0000100000000002L});
    public static final BitSet FOLLOW_ruleXClosure_in_ruleXFeatureCall7360 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleIdOrSuper_in_entryRuleIdOrSuper7398 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleIdOrSuper7409 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleIdOrSuper7456 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_53_in_ruleIdOrSuper7480 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleStaticQualifier_in_entryRuleStaticQualifier7521 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleStaticQualifier7532 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleStaticQualifier7579 = new BitSet(new long[]{0x0040000000000000L});
    public static final BitSet FOLLOW_54_in_ruleStaticQualifier7597 = new BitSet(new long[]{0x0000000000000082L});
    public static final BitSet FOLLOW_ruleXStringLiteral_in_entryRuleXStringLiteral7642 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXStringLiteral7652 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleXStringLiteral7703 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXCatchClause_in_entryRuleXCatchClause7752 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXCatchClause7762 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_55_in_ruleXCatchClause7807 = new BitSet(new long[]{0x0000040000000000L});
    public static final BitSet FOLLOW_42_in_ruleXCatchClause7820 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleFullJvmFormalParameter_in_ruleXCatchClause7841 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_43_in_ruleXCatchClause7853 = new BitSet(new long[]{0x00210421C007E0F0L});
    public static final BitSet FOLLOW_ruleXExpression_in_ruleXCatchClause7874 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleQualifiedName_in_entryRuleQualifiedName7911 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleQualifiedName7922 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleQualifiedName7969 = new BitSet(new long[]{0x0000000000080002L});
    public static final BitSet FOLLOW_19_in_ruleQualifiedName7997 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ruleValidID_in_ruleQualifiedName8020 = new BitSet(new long[]{0x0000000000080002L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_entryRuleJvmTypeReference8067 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleJvmTypeReference8077 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmParameterizedTypeReference_in_ruleJvmTypeReference8125 = new BitSet(new long[]{0x0000100000000002L});
    public static final BitSet FOLLOW_44_in_ruleJvmTypeReference8163 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_ruleJvmTypeReference8175 = new BitSet(new long[]{0x0000100000000002L});
    public static final BitSet FOLLOW_ruleXFunctionTypeRef_in_ruleJvmTypeReference8207 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXFunctionTypeRef_in_entryRuleXFunctionTypeRef8242 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleXFunctionTypeRef8252 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_42_in_ruleXFunctionTypeRef8290 = new BitSet(new long[]{0x01000C0000000080L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleXFunctionTypeRef8312 = new BitSet(new long[]{0x00000A0000000000L});
    public static final BitSet FOLLOW_41_in_ruleXFunctionTypeRef8325 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleXFunctionTypeRef8346 = new BitSet(new long[]{0x00000A0000000000L});
    public static final BitSet FOLLOW_43_in_ruleXFunctionTypeRef8362 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_ruleXFunctionTypeRef8376 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleXFunctionTypeRef8397 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmParameterizedTypeReference_in_entryRuleJvmParameterizedTypeReference8433 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleJvmParameterizedTypeReference8443 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleQualifiedName_in_ruleJvmParameterizedTypeReference8491 = new BitSet(new long[]{0x0000000040000002L});
    public static final BitSet FOLLOW_30_in_ruleJvmParameterizedTypeReference8512 = new BitSet(new long[]{0x0300040000000080L});
    public static final BitSet FOLLOW_ruleJvmArgumentTypeReference_in_ruleJvmParameterizedTypeReference8534 = new BitSet(new long[]{0x0000020020000000L});
    public static final BitSet FOLLOW_41_in_ruleJvmParameterizedTypeReference8547 = new BitSet(new long[]{0x0300040000000080L});
    public static final BitSet FOLLOW_ruleJvmArgumentTypeReference_in_ruleJvmParameterizedTypeReference8568 = new BitSet(new long[]{0x0000020020000000L});
    public static final BitSet FOLLOW_29_in_ruleJvmParameterizedTypeReference8582 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmArgumentTypeReference_in_entryRuleJvmArgumentTypeReference8620 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleJvmArgumentTypeReference8630 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleJvmArgumentTypeReference8677 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmWildcardTypeReference_in_ruleJvmArgumentTypeReference8704 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmWildcardTypeReference_in_entryRuleJvmWildcardTypeReference8739 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleJvmWildcardTypeReference8749 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_57_in_ruleJvmWildcardTypeReference8795 = new BitSet(new long[]{0x0420000000000002L});
    public static final BitSet FOLLOW_ruleJvmUpperBound_in_ruleJvmWildcardTypeReference8817 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmLowerBound_in_ruleJvmWildcardTypeReference8844 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmUpperBound_in_entryRuleJvmUpperBound8882 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleJvmUpperBound8892 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_58_in_ruleJvmUpperBound8929 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleJvmUpperBound8950 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmUpperBoundAnded_in_entryRuleJvmUpperBoundAnded8986 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleJvmUpperBoundAnded8996 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_59_in_ruleJvmUpperBoundAnded9033 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleJvmUpperBoundAnded9054 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmLowerBound_in_entryRuleJvmLowerBound9090 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleJvmLowerBound9100 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_53_in_ruleJvmLowerBound9137 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_ruleJvmLowerBound9158 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleValidID_in_entryRuleValidID9197 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleValidID9208 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleValidID9247 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_38_in_synpred9_InternalEL4431 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_19_in_synpred10_InternalEL4585 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ruleValidID_in_synpred10_InternalEL4594 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_ruleOpSingleAssign_in_synpred10_InternalEL4600 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_19_in_synpred11_InternalEL4703 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_39_in_synpred11_InternalEL4717 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_40_in_synpred11_InternalEL4737 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_42_in_synpred12_InternalEL4964 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_synpred13_InternalEL5016 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_41_in_synpred13_InternalEL5023 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_synpred13_InternalEL5030 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_45_in_synpred13_InternalEL5044 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXClosure_in_synpred14_InternalEL5162 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_synpred15_InternalEL5292 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_41_in_synpred15_InternalEL5299 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_synpred15_InternalEL5306 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_45_in_synpred15_InternalEL5320 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_49_in_synpred17_InternalEL6103 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmTypeReference_in_synpred18_InternalEL6574 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ruleValidID_in_synpred18_InternalEL6583 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_42_in_synpred19_InternalEL7145 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_synpred20_InternalEL7197 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_41_in_synpred20_InternalEL7204 = new BitSet(new long[]{0x0100040000000080L});
    public static final BitSet FOLLOW_ruleJvmFormalParameter_in_synpred20_InternalEL7211 = new BitSet(new long[]{0x0000220000000000L});
    public static final BitSet FOLLOW_45_in_synpred20_InternalEL7225 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleXClosure_in_synpred21_InternalEL7343 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_19_in_synpred23_InternalEL7988 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_synpred24_InternalEL8140 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_synpred24_InternalEL8144 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_30_in_synpred25_InternalEL8504 = new BitSet(new long[]{0x0000000000000002L});
