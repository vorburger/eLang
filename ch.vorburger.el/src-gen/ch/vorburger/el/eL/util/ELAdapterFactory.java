 ...
 * @generated
 */
public class ELAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected ELSwitch<Adapter> modelSwitch =
    new ELSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link ch.vorburger.el.eL.DateLiteral <em>Date Literal</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link ch.vorburger.el.eL.DateTimeLiteral <em>Date Time Literal</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link ch.vorburger.el.eL.DecimalLiteral <em>Decimal Literal</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
