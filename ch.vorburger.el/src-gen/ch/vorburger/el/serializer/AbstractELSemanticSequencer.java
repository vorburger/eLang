...
public class AbstractELSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected ELGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ELPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case ELPackage.DATE_LITERAL:
				if(context == grammarAccess.getDateLiteralRule() ||
			...
			case ELPackage.DATE_TIME_LITERAL:
				if(context == grammarAccess.getDateTimeLiteralRule() ||
				   context == grammarAccess.getXAdditiveExpressionRule() ||
				   context == grammarAccess.getXAdditiveExpressionAccess().getXBinaryOperationLeftOperandAction_1_0_0_0() ||
				   context == grammarAccess.getXAndExpressionRule() ||
				   context == grammarAccess.getXAndExpressionAccess().getXBinaryOperationLeftOperandAction_1_0_0_0() ||
			...
			case XbasePackage.XINT_LITERAL:
				if(context == grammarAccess.getXIntLiteralRule()) {
	 ...
	 *     value=Date
	 */
	protected void sequence_DateLiteral(EObject context, DateLiteral semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ELPackage.Literals.DATE_LITERAL__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ELPackage.Literals.DATE_LITERAL__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getDateLiteralAccess().getValueDateParserRuleCall_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *     value=Date_Time
	 */
	protected void sequence_DateTimeLiteral(EObject context, DateTimeLiteral semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ELPackage.Literals.DATE_TIME_LITERAL__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ELPackage.Literals.DATE_TIME_LITERAL__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getDateTimeLiteralAccess().getValueDate_TimeParserRuleCall_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	protected void sequence_DecimalLiteral(EObject context, DecimalLiteral semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ELPackage.Literals.DECIMAL_LITERAL__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ELPackage.Literals.DECIMAL_LITERAL__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getDecimalLiteralAccess().getValueNumberParserRuleCall_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *         (leftOperand=XRelationalExpression_XBinaryOperation_1_0_0_0 feature=[JvmIdentifiableElement|OpCompare] rightOperand=XOtherOperatorExpression) | 
